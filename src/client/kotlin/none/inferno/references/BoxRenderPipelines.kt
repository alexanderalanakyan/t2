...
object BoxRenderPipelines {

     val unculledBoxPipeline = RenderPipelines.register(
        ...
        val boxPipeline = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
       ...
       val unculledLinesPipeline = RenderPipelines.register(
       ...
       val linesPipeline = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.LINES_SNIPPET)
